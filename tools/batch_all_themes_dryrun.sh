#!/bin/bash
# DRY-RUN: Batch generation for all hassaku-teasing themes
# Tests the batch without actually generating images
...
../local-sd-generator/tools/batch_generate.sh --dry-run -t "$TEMPLATE" \
